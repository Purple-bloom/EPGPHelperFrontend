...
export default function Home() {
    return (
            <div className="bg-dark text-light app-container">
                ...
                <p className = "textSmall">This is an EPGP helper. This website allows you to award EP and GP by character-to-player matching, add players and their characters, export to a supported addon (like github.com/Purple-bloom/EpgpWhisperer) </p>
